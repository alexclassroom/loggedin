...
::: tip Extensibility
Third-party plugins or custom code can introduce additional login logic options by utilizing the available WordPress filter hooks. Developers can refer to [the plugin's documentation](./available-hooks) for details on extending this functionality.
:::