 ...
 * root with broken positioning and a transparent background.
 *
 * The page tree is also wrapped in an {@see ErrorBoundary} so a
 * render-time throw degrades to an inline error notice instead of
 * unmounting the whole root to a blank page.
 *
 * @param {Object} props
